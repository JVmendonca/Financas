...
public class UpdateUserTest : FinancasClassFixture
{
    ...
    public UpdateUserTest(CustomWepApplicationFactory webApplicationFactory) : base(webApplicationFactory)
    {
    ...
    public async Task Error_Empty_Nome(string culture)
    {
        var request = RequestUpdateUserJsonBuilder.Build();
