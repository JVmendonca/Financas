...
public class RegisterDespesasUseCase : IRegisterDespesaUseCase
{
    private readonly IDespesasWriteOnlyRepositorio _repositorio;
    private readonly IUnitOfWork _unitOfWork;
    private readonly IMapper _mapper;
    private readonly ILoggedUser _loggedUser;
    public RegisterDespesasUseCase(IDespesasWriteOnlyRepositorio repositorio, IUnitOfWork unitOfWork, IMapper mapper, ILoggedUser loggedUser)
    {
